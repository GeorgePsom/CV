...
for train, test in kfold.split(train_images, train_labels):
    ...
    if fold_no ==1 and generatePlots==1:
        ...
        model.save_weights('data/model/ArchMainWeights')
        #model.save('data/model/model' + str(fold_no))

        model_json = model.to_json()
        with open('data/architecture/architectureMain.json', "w") as json_file:
...
for train, test in kfold.split(train_images, train_labels):
    ...
    print('------------------------------------------------------------------------')
    print(f'Training for fold {fold_no} ...')
    history = model.fit(train_images[train], train_labels[train], batch_size = 128, epochs = 15, verbose = 2, callbacks=[callback], validation_data = (train_images[test],train_labels[test]))
    ...
    if fold_no == 1 and generatePlots==1:
        ...
        plt.ylabel('Accuracy')
        plt.legend(loc='lower right')
        plt.savefig('data/plots/AdaptiveLearning1Acc.png')
        plt.close()
        ...
        plt.ylabel('Loss')
        plt.legend(loc='upper right')
        plt.savefig('data/plots/AdaptiveLearning1Loss.png')
        plt.close()

        model.save_weights('data/model/AdaptiveLearning1weights')
        #model.save('data/model/model' + str(fold_no))

        model_json = model.to_json()
        with open('data/architecture/architecture.json', "w") as json_file:
            json_file.write(model_json)
...
for train, test in kfold.split(train_images, train_labels):
    ...
    if fold_no == 1 and generatePlots==1:
        ...
        plt.ylabel('Accuracy')
        plt.legend(loc='lower right')
        plt.savefig('data/plots/Dense3Acc.png')
        plt.close()
        ...
        plt.ylabel('Loss')
        plt.legend(loc='upper right')
        plt.savefig('data/plots/Dense3Loss.png')
        plt.close()

        model.save_weights('data/model/Dense3weights')
        #model.save('data/model/model' + str(fold_no))

        model_json = model.to_json()
        with open('data/architecture/architectureDense3.json', "w") as json_file:
            json_file.write(model_json)
...
for train, test in kfold.split(train_images, train_labels):
    ...
    if fold_no == 1 and generatePlots==1:
        ...
        plt.ylabel('Accuracy')
        plt.legend(loc='lower right')
        plt.savefig('data/plots/Kernel4Acc.png')
        plt.close()
        ...
        plt.ylabel('Loss')
        plt.legend(loc='upper right')
        plt.savefig('data/plots/Kernel4Loss.png')
        plt.close()

        model.save_weights('data/model/Kernel4weights')
        #model.save('data/model/model' + str(fold_no))

        model_json = model.to_json()
        with open('data/architecture/architectureKernel4.json', "w") as json_file:
            json_file.write(model_json)
