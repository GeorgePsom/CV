...
class Scene3DRenderer
{
	...
	std::vector<std::vector<cv::Point3f>> colorModel;
...
public:
	...
	std::vector<std::vector<cv::Point3f>> getColorModel() const
	{
		return colorModel;
	}

	void updateColorModel(std::vector<std::vector<cv::Point3f>> colorMod)
	{
		colorModel.clear();
