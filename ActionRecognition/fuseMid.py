...
history = new_model.fit([X_train_imagesTransfer, X_train_imagesOpt], train_labels, batch_size = 1, epochs = 30, verbose = 2, callbacks=[lrdecay], validation_data = ([X_test_imagesTransfer, X_test_imagesOpt], test_labels))
